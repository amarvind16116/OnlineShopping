...
<body>
	...
	<jsp:include page="/ViewProductByBrand">
		<jsp:param value="Apple" name="brand"/>
	</jsp:include>


<div class="col-md-12 pull-right Mycontainer">
	<div class="row panel panel-default">
		<div class="panel-heading"><font size=5>Apple iPhones</font><a class="pull-right btn btn-danger" href="View_Products.jsp?brand=Apple">View All</a></div>
