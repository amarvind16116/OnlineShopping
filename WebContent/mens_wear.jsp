...
<body>
	...
	<jsp:include page="/ViewProductByCategory">
		<jsp:param value="7" name="category"/>
	</jsp:include>
...
<div class="col-md-12">
	<div class="row">
		<div class="col-md-3 text-center">
			<br/>
			<h2 class="text-danger text-center">Deals on Men's </br> Wear </h2><br/>
		    ...
		    <div class="carousel-inner" role="listbox">		
		      <div class="item active">
				...
				<c:forEach items="${products}" var="s" begin="0" end="5">
					...
					<a href="ViewProductById?id=${s.getProduct_id()}" class="thumbnail">
						<img src="images/mens_wear/${s.getImg()}" alt="${s.getImg()}" style="height:200px;">
					</a>
					<div>
						<h5 class="text-danger text-center"><a href="view_item.jsp?id=${s.getProduct_id() }"></a> ${s.getProduct_name() }</h5>
					</div>
					</div>
				</c:forEach>
			    </div>
			  ...
			  <div class="item">
				...
				<c:forEach items="${products}" var="s" begin="6" end="11">
					...
					<a href="ViewProductById?id=${s.getProduct_id() }" class="thumbnail">
						<img src="images/mens_wear/${s.getImg()}" alt="${s.getImg()}" style="height:170px;">
					</a>
					<div>
						<h5 class="text-danger text-center"><a href="view_item.jsp?id=${s.getProduct_id() }"></a> ${s.getProduct_name() }</h5>
					</div>
